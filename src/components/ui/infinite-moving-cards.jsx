  ...
  return (
    (<div
      ...
      <ul
        ...
        {items.map((item, idx) => (
          <li
            className="w-[350px] bg-white max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-white px-8 py-6 md:w-[450px]"
            // style={{
            //   background:
            ...
            <blockquote>
              ...
              <span
                className=" relative z-20 text-sm leading-[1.6] text-zinc-800 font-normal">
                {item.quote}
              </span>
